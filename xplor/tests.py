...
class MyTestCase(unittest.TestCase):
    def test_xdata_module_DimensionDescription_class(self):
        ...
        rcopy = r.copy()
        fcopy = f.copy()
        self.assertEqual(pcopy.all_units, [{'unit': 'euros', 'value': 1}])
        self.assertEqual(rcopy.all_units, [{'unit': 'ms', 'value': 0.001},
                                           {'unit': 's', 'value': 1.0},
                                           {'unit': 'min', 'value': 60.0},
                                           {'unit': 'hour', 'value': 3600.0}])
        self.assertTrue(fcopy.all_units is None)
        print("\n")
    ...
    def test_xdata_module_CategoricalHeader_class(self):
        ...
        print("Test 9: testing the is_categorical, is_measure, "
              "is_categoricalwithvalue, and is_undifferentiated")
        ...
        self.assertRaises(Exception, fruits.get_itemname, -10)
        self.assertRaises(Exception, fruits.get_itemname,
                          ['chocolate', 'milk'])
        self.assertRaises(Exception, fruits.get_itemname, [10])
        ...
        self.assertEqual(allfruits.column_descriptors[1].dimension_type,
                         'mixed')
        ...
        self.assertEqual(newfruits.column_descriptors[1].dimension_type,
                         'mixed')
        ...
        self.assertEqual(chgfruits.column_descriptors[1].dimension_type,
                         'mixed')
        ...
        self.assertEquals(
            chgandnewfruits1.column_descriptors[1].dimension_type,
            chgandnewfruits2.column_descriptors[1].dimension_type,
            'mixed')
        self.assertRaises(Exception, fruits.update_categoricalheader,
        ...
        self.assertEqual(chgandrmfruits.get_n_columns(),
        ...
        self.assertEquals(chgandrmfruits.column_descriptors[1].dimension_type,
                          'mixed')
        self.assertRaises(Exception, fruits.update_categoricalheader,
                          'chg&rm', 1, series)
        self.assertRaises(Exception, fruits.update_categoricalheader,
        ...
        self.assertEqual(newfruits1.column_descriptors[3].dimension_type,
                         'numeric')
        ...
        self.assertEqual(newfruits2.column_descriptors[3].dimension_type,
                         'numeric')
        ...
        self.assertEqual(copyfruits.get_n_columns(), 4)
        self.assertEqual(fruits2.column_descriptors[2].dimension_type,
                         'string')
    ...
    def test_xdata_module_Xdata_class(self):
        ...
        self.assertEqual(setofdata.data_descriptor.dimension_type, 'numeric')
        print("Test 3: raising errors for arguments with wrong types")
        self.assertRaises(Exception,
                          xdata.Xdata,
                          1,
        ...
        self.assertEqual(setofdata.get_n_dimensions(), 3)
        ...
        self.assertEqual(udsetofdata1.get_n_dimensions(), 3)
        self.assertEqual(udsetofdata2.get_n_dimensions(), 3)
